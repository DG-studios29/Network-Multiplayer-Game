...
public class RockSpawner : MonoBehaviour
{
    ...
    public Vector3 spawnCenter = Vector3.zero; // <<< CENTER of your water area
    ...
    void SpawnRocks()
    {
        ...
        while (rocksSpawned < numberOfRocks && attempts < numberOfRocks * 10)
        {
            ...
            if (SpawnManager.Instance.IsPositionAvailable(randomPos)) // <<< USE global check
            {
                ...
                SpawnManager.Instance.RegisterPosition(randomPos); // <<< Register rock position globally
                rocksSpawned++;
            }
